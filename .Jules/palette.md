...
**Learning:** Pairing an empty state message with actionable instructions (e.g., "Use 'command' to create one") provides a clear next step for the user, improving the experience and avoiding dead ends.
**Action:** When designing CLI interfaces, always pair empty state messages with clear, actionable instructions or commands on how to create the missing resource to improve user experience and avoid dead-ends.
